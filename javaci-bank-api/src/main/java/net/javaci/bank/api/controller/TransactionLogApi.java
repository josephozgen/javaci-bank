...
import net.javaci.bank.api.dto.ExchangeTransactionDto;
import net.javaci.bank.api.dto.SingleAccountTransactionDto;
import net.javaci.bank.api.dto.TransactionLogDto;
import net.javaci.bank.api.dto.TransferTransactionDto;
import net.javaci.bank.api.helper.ModelValidationHelper;
import net.javaci.bank.db.dao.AccountDao;
import net.javaci.bank.db.dao.impl.ExchangeRateDaoImpl;
import net.javaci.bank.db.dao.impl.TransactionLogDaoImpl;
...
public class TransactionLogApi {
    ...
    public TransactionLogDto buyExchange(@RequestBody @Valid ExchangeTransactionDto exchangeRequest) {
        ...
        transactionLog.setDate(LocalDate.now());
        transactionLog.setDescription("");
        transactionLog.setType(TransactionLogType.MONEY_EXCHANGE);
        transactionLogDao.save(transactionLog);
